...
const LinkCard: React.FC<LinkCardProps> = ({ link, onDelete, accentColor, themeClasses }) => {
  ...
  return (
    <a 
      ...
      className={`group relative aspect-square flex flex-col items-center justify-center ${themeClasses.card} rounded-lg p-4 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 animate-fadeIn`}
    >
      <img src={faviconUrl} alt="" className="w-12 h-12 mb-3 rounded-md object-contain" />
